...
if __name__ == "__main__":
    ...
    splitted_sentences = parser.split(text)
    ...
    if score > 0:
        print("You seem pretty positive today, I am glad.")
    elif score == 0:
        print("Hmm I cannot figure you out, say something else and I will try again?")
    else:
        print("I am sorry you are upset, I am sure it is not your fault.")
